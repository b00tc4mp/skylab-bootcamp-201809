...
class Boards extends Component {
    ...
    render() {
        return <section className="container__boards">
            ...
            {this.state.search.map(board => <li className='list__boards__item' onClick={() => this.props.handleSelectBoard(board)} id={board.id}> {board.title} <button className="button-list" type="submit" >Select</button></li> )}
            </ul>
