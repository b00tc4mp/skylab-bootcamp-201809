...
class EditBoard extends Component {
    state = { board: this.props.board, title: this.props.board.title, description: this.props.board.description, category: this.props.board.category, secret: this.props.board.secret, merge: false, editBoard : null }
    ...
    handleDelete = () => {
        this.props.onDeleteBoard(this.board.id)
    }
