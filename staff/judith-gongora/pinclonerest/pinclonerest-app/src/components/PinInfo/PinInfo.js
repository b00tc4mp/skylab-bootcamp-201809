                        ...
                        <div className='container1'>
                            <div className='container2-info'>
                                ...
                                {!this.state.board ? <div className='container__pinned'>
                                    <div className="themes1" onClick={this.handleClickThemes}>
                                        <span>Boards</span>
                                        <svg  height="12" width="12" viewBox="0 0 24 24" aria-label="Selecciona un tablero en el que quieras guardar Pines" role="img">
